...
RECOMMENDATION_PURPOSES = {
    "writing": {"label": "Writing and research", "categories": {"artificial intelligence", "productivity", "office"}, "keywords": {"writing", "research", "notes", "assistant", "documents"}},
    ...
    "design": {"label": "Design and image creation", "categories": {"design", "artificial intelligence"}, "keywords": {"design", "photo editing", "illustration", "graphics", "ui", "image"}},
    "video": {"label": "Video and audio production", "categories": {"video", "audio"}, "keywords": {"video editing", "recording", "audio", "animation", "production"}},
    "productivity": {"label": "Productivity and organization", "categories": {"productivity", "office", "communication"}, "keywords": {"productivity", "tasks", "notes", "calendar", "collaboration", "workflow"}},
    "privacy": {"label": "Privacy and local-first work", "categories": {"security", "browser", "artificial intelligence"}, "keywords": {"privacy", "encryption", "local ai", "self hosted", "offline", "security"}},
}
