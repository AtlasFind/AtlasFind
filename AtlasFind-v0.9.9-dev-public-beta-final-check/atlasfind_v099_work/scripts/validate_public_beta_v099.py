...
if 'APP_VERSION = "0.9.9-dev"' not in app_text:
    ERRORS.append("APP_VERSION is not 0.9.9-dev")
...
if ERRORS:
    print("v0.9.9 public beta validation failed:")
    for error in ERRORS:
        print(f"- {error}")
...
print("v0.9.9 public beta validation successful.")
